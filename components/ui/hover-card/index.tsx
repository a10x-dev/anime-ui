...
const HoverCardContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof HoverCardPrimitive.Content> & {
    ...
    // Theme variant similar to dropdown
    ...
    return (
      <HoverCardPrimitive.Content
        ...
        className={cn(
          ...
          `ghibli-hover-card-theme-${variant}`,
          className
        )}
        {...props}
        asChild
      >
        <motion.div {...selectedAnimation} style={{ originX: 0.5, originY: 0 }}>
          ...
          {variant === 'spirit' && (
            <div className="ghibli-hover-card-spirit-effect"></div>
          )}
          {variant === 'nature' && (
            <div className="ghibli-hover-card-nature-effect"></div>
          )}
        </motion.div>
      </HoverCardPrimitive.Content>
    );
